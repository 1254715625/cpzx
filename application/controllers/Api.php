...
class Api extends MY_Controller
{
    ...
    public function get_content($status = '', $type_id = '', $id = '')
    {
        ...
        $sql = "select a.id,a.img ,a.title,a.shorttitle,a.click,a.newstime,c.content,a.addtime,c.local_time from tx_news as a,tx_news_type as b ,tx_news_content as c ,tx_news_status as d where a.typeid=b.id and  a.id=c.id  and a.status = d.id";
