...
;(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        factory(
            require('jquery'),
            require('angular'),
            require('./jquery.file_upload-image'),
            require('./jquery.file_upload-audio'),
            require('./jquery.file_upload-video'),
            require('./jquery.file_upload-validate')
        );
    } else {
        factory();
    }
    ...
    angular.module('blueimp.fileupload', [])
        ...
        // The FileUploadController initializes the file_upload widget and
        ...
        .controller('FileUploadController', [
            ...
            function ($scope, $element, $attrs, $window, fileUpload, $q) {
                ...
                // The file_upload widget will initialize with
